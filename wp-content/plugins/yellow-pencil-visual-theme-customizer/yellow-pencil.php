...
//define('YP_HTML_EDITOR', TRUE); // Work-in process.
...
function yp_css_prefix($outputCSS){
	...
	// Gradient browser prefixes to the property value: webkit / o
	$outputCSS = preg_replace('@background-image:linear-gradient([^\{]+);@U',"background-image:linear-gradient$1;\r	background-image:-o-linear-gradient$1;\r	background-image:-webkit-linear-gradient$1;",$outputCSS);
